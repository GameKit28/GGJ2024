...
namespace MeEngine
{
    ...
    {
        //--Custom Logging options for Kit--
        //These logs will only be visible if the current user is USER_KIT. (Set in the smcs.rsp file)
        public class Kit
        {
            private const string UserName = "USER_KIT";
